...
HD_PWD='O:/CS56-22S/midi_project/midi_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log midi_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source midi_shell.tcl
