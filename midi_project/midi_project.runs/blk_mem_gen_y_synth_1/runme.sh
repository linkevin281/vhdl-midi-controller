...
HD_PWD='O:/midi_project/midi_project.runs/blk_mem_gen_y_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_y.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_y.tcl
