...
HD_PWD='O:/CS56-22S/midi_project/midi_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log midi_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source midi_shell.tcl -notrace
