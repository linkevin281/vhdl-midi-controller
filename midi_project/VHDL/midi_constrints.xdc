...
set_property PACKAGE_PIN U16 [get_ports {status_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[0]}]
## LED 1
set_property PACKAGE_PIN E19 [get_ports {status_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[1]}]
## LED 2
set_property PACKAGE_PIN U19 [get_ports {status_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[2]}]
## LED 3
set_property PACKAGE_PIN V19 [get_ports {status_out[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[3]}]
## LED 4
set_property PACKAGE_PIN W18 [get_ports {status_out[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[4]}]
## LED 5
set_property PACKAGE_PIN U15 [get_ports {status_out[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[5]}]
## LED 6
set_property PACKAGE_PIN U14 [get_ports {status_out[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[6]}]
## LED 7
set_property PACKAGE_PIN V14 [get_ports {status_out[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {status_out[7]}]
### LED 8
#set_property PACKAGE_PIN V13 [get_ports {result_port[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[8]}]
### LED 9
#set_property PACKAGE_PIN V3 [get_ports {result_port[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[9]}]
### LED 10
#set_property PACKAGE_PIN W3 [get_ports {result_port[10]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[10]}]
### LED 11
#set_property PACKAGE_PIN U3 [get_ports {result_port[11]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[11]}]
### LED 12
#set_property PACKAGE_PIN P3 [get_ports {result_port[12]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[12]}]
### LED 13
#set_property PACKAGE_PIN N3 [get_ports {result_port[13]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[13]}]
### LED 14
#set_property PACKAGE_PIN P1 [get_ports {result_port[14]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[14]}]
### LED 15 (LEFT MOST LED)
#set_property PACKAGE_PIN L1 [get_ports {result_port[15]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {result_port[15]}]
...
set_property PACKAGE_PIN L2 [get_ports {add_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {add_out}]
##Sch name = JA3
...
set_property PACKAGE_PIN H1 [get_ports {out_clock_port}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {out_clock_port}]
##Sch name = JA8
...
set_property PACKAGE_PIN A14 [get_ports {well_formed_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {well_formed_out}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {delete_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {delete_out}]
##Sch name = JB3
...
set_property PACKAGE_PIN B16 [get_ports {note_on_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {note_on_out}]
##Sch name = JB7
 set_property PACKAGE_PIN A15 [get_ports {note_off_out}]					
 	set_property IOSTANDARD LVCMOS33 [get_ports {note_off_out}]
##Sch name = JB8
# set_property PACKAGE_PIN A17 [get_ports {stat_shift_out}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {stat_shift_out}]
##Sch name = JB9
#set_property PACKAGE_PIN C15 [get_ports {update_out}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {update_out}}]
##Sch name = JB10 
#set_property PACKAGE_PIN C16 [get_ports {add_out}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {add_out}]
...
set_property PACKAGE_PIN K17 [get_ports {vel_shift_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {vel_shift_out}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {val_shift_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {val_shift_out}]
##Sch name = JC3
...
set_property PACKAGE_PIN P18 [get_ports {stat_shift_out}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {stat_shift_out}]
##Sch name = JC7
#set_property PACKAGE_PIN L17 [get_ports {{update_out}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {{update_out}]
##Sch name = JC8
#set_property PACKAGE_PIN M19 [get_ports {add_out}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {add_out}]
##Sch name = JC9
...
set_property PACKAGE_PIN L3 [get_ports {check_out}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {check_out}]
#Sch name = XA3_P	
# set_property PACKAGE_PIN M2 [get_ports {delete_out}]				
# 	set_property IOSTANDARD LVCMOS33 [get_ports {delete_out}]
#Sch name = XA4_P
# set_property PACKAGE_PIN N2 [get_ports {store_out}]				
# 	set_property IOSTANDARD LVCMOS33 [get_ports {store_out}]
#Sch name = XA1_N
