...
#
# Generated by export_simulation on Mon May 30 11:39:36 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_y.sh' script.

./blk_mem_gen_y.sh -reset_run
...
./blk_mem_gen_y.sh -noclean_files

For more information on the script, please type './blk_mem_gen_y.sh -help'.
